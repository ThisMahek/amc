...
class Franchisestudent_controller extends Admin_Core_Controller
{
    ...
    public function add_student()
    {
        ...
        $this->load->view('franchise/student/add_student', $data);
    ...
    public function add_student_post()
    {
        ...
        else 
        {
            ...
            if($this->student_model->add($franchise_id))
            {
                ...
                redirect(franchise_url() . "students");
            }else{
    ...
    {
        $franchise_id = $this->franchise_id;
        $data['students'] = $this->student_model->get_all_students($franchise_id);
        $data['title'] = ("Students");
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/students', $data);
        $this->load->view('franchise/includes/footer');
    }
    public function pending_students()
    {
        $franchise_id = $this->franchise_id;
        $data['students'] = $this->student_model->get_all_pending_students($franchise_id);
        $data['title'] = ("Pending Approval Students");
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/pending_students', $data);
        $this->load->view('franchise/includes/footer');
    }
    ...
    {
        $franchise_id = $this->franchise_id;
        $data['students'] = $this->student_model->get_all_dispute_students($franchise_id);
        $data['title'] = ("Dispute Students");
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/dispute_students', $data);
        $this->load->view('franchise/includes/footer');
    }
    ...
    {
        $franchise_id = $this->franchise_id;
        $data['students'] = $this->student_model->get_all_reject_students($franchise_id);
        $data['title'] = ("Rejected Students");
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/reject_students', $data);
        $this->load->view('franchise/includes/footer');
    }
    ...
    {
        $franchise_id = $this->franchise_id;
        $data['students'] = $this->student_model->get_all_approved_students($franchise_id);
        $data['title'] = ("Approved Students");
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/approved_students', $data);
        $this->load->view('franchise/includes/footer');
    }
    ...
    public function view_application($id)
    {
        ...
        $this->load->view('franchise/includes/header', $data);
        $this->load->view('franchise/student/application_details', $data);
        $this->load->view('franchise/includes/footer');
    }
    ...
    public function reject_student_app($id)
    {
        ...
        if (!empty($student)) {
            ...
            $this->load->view('franchise/includes/header', $data);
            $this->load->view('franchise/student/reject_application', $data);
    ...
    public function edit_application($id)
    {
        ...
        if (!empty($student)) {
            ...
            $data['courses'] = $this->course_model->get_all_courses();
            $this->load->view('franchise/includes/header', $data);
            $this->load->view('franchise/student/edit_application', $data);
            $this->load->view('franchise/includes/footer', $data);
        } else {
            $this->session->set_flashdata('error', "Invalid User");
            redirect($this->agent->referrer());
    ...
    public function approve_application($id)
    {
        ...
        if (!empty($student)) {
            ...
            $this->load->view('franchise/includes/header', $data);
            $this->load->view('franchise/student/approve_application', $data);
            $this->load->view('franchise/includes/footer', $data);
        } else {
            $this->session->set_flashdata('error', "Invalid User");
            redirect($this->agent->referrer());
