...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/multiselect/bootstrap-multiselect.css"   />
    <!-- Style CSS -->
                    ...
                    <div class="d-flex justify-content-end align-items-center respon-sprade">
                        ...
                        <?php else : ?>
                            <ul class="d-flex right-top justify-content-center">
                                ...
                                <li><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#franchise_login_modal"  >Franchise Registration</a></li>
                                <!-- <li><a href="<?php echo base_url() . 'franchise-registration' ?>" >Franchise Registration</a></li> -->
                            </ul>
                        <?php endif; ?>
