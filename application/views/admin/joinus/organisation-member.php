 ...
 <div class="wrapper2">
     <div class="mblog">
         ...
         <?php echo form_open('admin/update_organisation_member_settings'); ?>
         <div class="row">
             <div class="col-md-6">
                 <div class="form-group">
                     <label>Setting Language</label>
                     <select name="lang_id" class="form-control" onchange="window.location.href = '<?php echo admin_url(); ?>organisation-member-settings?lang='+this.value;" style="max-width: 600px;">
