<div class="post-b">
    <div class="post-h">
        <h5>Edit Job</h5>
        <a class="btn btn-primary" href="<?php echo admin_url() . 'jobs' ?>">All Jobs</a>
    </div>
    <div class="row">
        <div class="col-md-8">
            <div class="post-d">
                ...
                <?php echo form_open('admin/update-job'); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="vacancy" class="form-control" placeholder="vacancy" required value="<?php echo $post->vacancy; ?>">
                </div>
                <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="post-d2">
                <div class="right-fast">
                    ...
                    <div class="featuredImg">
                        <?php if (!empty($post->featured_image)) : ?>
                            <img src="<?php echo base_url() . 'uploads/job_image/' . $post->featured_image ?>"><a href="javascript:void(0)" onclick="remove_job_featured_image(<?php echo $post->id ?>)"><i class="fa fa-times" aria-hidden="true"></i></a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="right-second">
                    ...
                    <div class="sml-imag extra_img_div">
                        <?php if (!empty($post->extra_image)) : ?>
                            <img src="<?php echo base_url() . 'uploads/job_image/' . $post->extra_image ?>"> <a href='javascript:void(0)' onclick='removeJobExtraImage(<?php echo $post->id ?>)'><i class='fa fa-times' aria-hidden='true'></i></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="right-third">
                    ...
                    <ul class="fileList">
                        <?php if (!empty($blog_files)) :
                            $i = 1;
                            foreach ($blog_files as $blog_file) : ?>
                                <li class="fileList<?php echo $i ?>"><i class="fa fa-file" aria-hidden="true"></i> <?php echo $blog_file->file_name; ?><a href="javascript:void(0)"><i class="fa fa-times" aria-hidden="true" onclick="remove_upload_Job_files('<?php echo $blog_file->id; ?>','<?php echo $i; ?>')"></i></a>
                                    <input type="hidden" name="file_id[]" value="<?php echo $blog_file->id; ?>">
                                    <input type="hidden" name="existingFile[]" value="<?php echo $blog_file->file_name; ?>">
                                </li>
                        <?php $i++;
                            endforeach;
                        endif; ?>
