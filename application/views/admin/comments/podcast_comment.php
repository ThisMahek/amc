            ...
            <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                    <?php foreach ($comments as $item) : ?>
                        <?php
                        $post = $this->podcasts_model->get_post($item->post_id);
                        $post_category = $this->podcasts_cat_model->get_category($post->category_id); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo generate_url("podcast") . "/" . $post_category->slug; ?>/<?php echo $post->slug; ?>" target="_blank"><?php echo html_escape($post->title); ?></a>

                            </td>
                            <td class="nowrap"><?php echo formatted_date($item->created_at); ?></td>
                            <td class="drp-btn">
                                <?php echo form_open('admin/approve_podcast_comment_post'); ?>
                                ...
                                <div class="dropdown drp">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <?php endif; ?>
                                        <?php echo form_close(); ?>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('admin/delete_podcast_comment_post','<?php echo $item->id; ?>','Are you want to delete this item?');">Delete <i class="fa fa-trash" aria-hidden="true"></i></a>
