<div class="wrapper2">
    ...
    <div class="mblog-post">
        ...
        <div class="table-responsive">
            ...
            <?php if ($student->status == "1") : ?>
                <tr>
                    ...
                    <td>Session</td>
                    <td><?php echo getSessionByID($student->session_id) ?></td>
                </tr>
        ...
        <div class="text-center">
            ...
            <?php if ($student->status == 0) : ?>
                <a href="<?php echo franchise_url() . 'approve-application/' . $student->id ?>" class="btn btn-success btn-lg app">Approve</a>
                <button class="btn btn-danger btn-lg dispute" onclick="disputApps()">Mark Disput</button>
            <?php endif; ?>
            <?php if ($student->status == 3) : ?>
                <a class="btn btn-danger btn-lg" href="<?php echo franchise_url() . 'reject-application/' . $student->id ?>">Reject Application</a>
            <?php endif; ?>
            <a href="<?php echo franchise_url(). 'pending-student' ?>" class="btn btn-primary btn-lg">Back</a>
            <a href="<?php echo franchise_url() . 'edit-student-application/' . $student->id ?>" class="btn btn-warning btn-lg">Edit Form</a>
        </div>
    </div>