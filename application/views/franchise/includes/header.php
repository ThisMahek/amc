    ...
    <ul class="categories">
      ...
      <li><i class="fa fa-users fa-fw"></i><a href="#">Student</a>
        <ul class="mside-nav-dropdown">
          <li><a href="<?php echo franchise_url() ?>students">Students</a></li>
          <li><a href="<?php echo franchise_url() ?>add-student">Add Student </a></li>
          <li><a href="<?php echo franchise_url() ?>pending-student">Pending Student </a></li>
          <li><a href="<?php echo franchise_url() ?>approved-student">Approved Student </a></li>
          <li><a href="<?php echo franchise_url() ?>rejected-student">Rejected Student </a></li>
          <li><a href="<?php echo franchise_url() ?>dispute-student">Dispute Student </a></li>
          <!-- <li><a href="<?php echo franchise_url() ?>search-student">Search Student </a></li> -->
        </ul>
      </li>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php echo franchise_url().'view_profile'; ?>"><i ></i> View Profile</a></li>
                <li><a href="<?php echo franchise_url().'update_view'; ?>"><i ></i> Update Profile</a></li>
