                     ...
                     <table>
                         ...
                         <tbody>
                             <tr>
                                 ...
                                 <td><input type="text" name="qual_details[passing_year][1]" class="form-control" maxlength="4" onkeypress="return isNumberKey(event)"></td>
                                 <td><input type="text" name="qual_details[board][1]" class="form-control" required></td>
                                 <td><input type="text" name="qual_details[total_marks][1]" class="form-control" maxlength="4" onkeypress="return isNumberKey(event)"></td>
                                 <td><input type="text" name="qual_details[marks_obtained][1]" class="form-control" required axlength="4" onkeypress="return isNumberKey(event)"></td>
                             ...
                             <tr>
                                 ...
                                 <td><input type="text" name="qual_details[passing_year][2]" class="form-control" axlength="4" onkeypress="return isNumberKey(event)"></td>
                                 <td><input type="text" name="qual_details[board][2]" class="form-control"></td>
                                 <td><input type="text" name="qual_details[total_marks][2]" class="form-control" axlength="4" onkeypress="return isNumberKey(event)"></td>
                                 <td><input type="text" name="qual_details[marks_obtained][2]" class="form-control" axlength="4" onkeypress="return isNumberKey(event)"></td>
