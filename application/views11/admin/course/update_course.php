        ...
        <div class="col-md-12">
            <div class="post-d">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total_fees" class="form-control" placeholder="0" value="<?php echo $page->total_fees ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="installment_fees" class="form-control" placeholder="0" value="<?php echo $page->installment_fees ?>" required readonly>
                </div>
                <div class="form-group">
