<div class="post-b">
    <div class="post-h">
        <h5>Add Student</h5>
        <a class="btn btn-primary" href="<?php echo admin_url() . 'students' ?>">All Student</a>
    </div>
    <div class="row">

        <div class="post-d">
            <?php $this->load->view('admin/includes/_messages'); ?>
            <?php echo form_open('admin/save-student'); ?>
            <div class="form-area">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-cover">
                            ...
                            <select class="form-control drop-arrow" name="course_id" onchange="get_session_by_course(this.value);" required>
                    ...
                    <!--   <div class="col-md-3 col-sm-6">
                        <div class="upload-photo">
                            <p class="photoupload-text text-center"> Graduation Marksheet</p>
                            <div class="image-holder">
                                <div class="graduate_marksheet_img_div">

                                </div>
                                <img id="imgPreview" class="graduate_marksheet_img" src="<?php //echo base_url() 
                                                                                            ?>assets/backend/images/noimg.png" alt="pic" />
                            </div>
                            <input class="custom-file-inputm" type="file" id="graduate_marksheet_img" required="true" onchange="uploadGraduateImg()" />
                            <p class="error-file graduate_marksheet_img-error"></p>
                        </div>
                    </div> -->
