<div class="wrapper">
    <div class="">
        <?php echo form_open('admin/home_project_settings_post'); ?>
        <div class="wrapper-box">
            <h1 class="text-center">Our Projects Section</h1>
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="lang_id" class="form-control" onchange="window.location.href = '<?php echo admin_url(); ?>project?lang='+this.value;" style="max-width: 600px;">
