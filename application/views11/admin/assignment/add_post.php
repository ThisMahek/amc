<div class="post-b">
    <div class="post-h">
        ...
        <div class="text-right madd-btn">
            <a href="<?php echo admin_url() ?>assignments" class="add-pag">Assignments</a>
        </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="post-d">
                ...
                <?php echo form_open('admin/save-assignment'); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="closing_date" class="form-control" placeholder="Title" required>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="post-d2">
                ...
                <div class="right-fifth">
                    <h5>Publish</h5>
                    <button type="submit">Add assignment Post</button>
                </div>
                <?php form_close(); ?>
            </div>
        </div>
