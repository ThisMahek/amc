...
<body>
  <aside class="mside-nav" id="show-mside-navigation1">
    ...
    <ul class="categories">
      ...
      <li class="f-list"><i class="fa fa-newspaper-o" aria-hidden="true"></i><a href="<?php echo student_url() . '' ?>">Marksheet</a></li>

      <li class="f-list"><i class="fa fa-newspaper-o" aria-hidden="true"></i><a href="<?php echo student_url() . '' ?>">Certificate</a></li>
