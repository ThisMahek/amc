...
|
*/
$config['base_url'] = 'http://localhost/amc';
...
$config['csrf_token_name'] = 'csrf_bigpage_name';
$config['csrf_cookie_name'] = 'csrf_bigpage_token';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
// $config['csrf_exclude_uris'] = array('ck-file-upload', 'save-application');
$config['csrf_exclude_uris'] = array('ck-file-upload');
