...
class Razorpay
{
	...
	public function __construct()
	{
		...
		$this->razorpay_client_id = $this->ci->general_settings->razorpay_key_id;
		$this->razorpay_secret = $this->ci->general_settings->razorpay_key_secret;
	...
	{
		$payments = $client->order->fetch($orderId)->payments();
		print_r($payments);
	}
}
